          ...
          <div className="w-[40%] flex flex-col justify-center items-start">
            ...
            <form action="" className="w-full mt-4">
              ...
              <div className="w-full grid grid-cols-2 grid-rows-2 gap-4">
                <Input placeholder="Data de ínicio" />
                <Input placeholder="Data de encerramento" />
                <Input placeholder="Hórario de ínicio" />
                <Input placeholder="Hórario de encerramento" />
              </div>

              <Title
                color="white"
                className="font-medium text-[20px] my-2 mt-4"
              >
                Localização
              </Title>
              <div className="w-full grid grid-cols-2 grid-rows-2 gap-4">
              ...
              <Input placeholder="Número do complemento" className="mt-4" />
